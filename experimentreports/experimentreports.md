# Relatório de Experimento com SplayTrees
...
**A Splay Tree não apresenta vantagens** em relação às árvores balanceadas na busca convencional, mesmo para maiores entradas.
...
![Gráfico de Busca Convencional](graficos/buscaconvencional.jpeg)

### 2\. Inserção

**A Splay Tree apresenta desempenho superior para entradas ordenadas em ordem crescente e decrescente** na inserção, mesmo quando apresentam menor tamanho. 
...
![Gráfico de Inserção Reversa](graficos/reverseinsert.jpeg) ![Gráfico de Inserção Aleatória](graficos/randominsert.jpeg)
...
![Gráfico de Inserção](graficos/insercao.jpeg)

### 3\. Search Hot

**A Splay Tree é mais eficiente que as árvores balanceadas para entradas de maior tamanho**.
...
![Gráfico de Search Random](graficos/searchrandom.jpeg)
![Gráfico de Search Reverse](graficos/searchreverse.jpeg)
![Gráfico de Search Sorted](graficos/searchsorted.jpeg)
